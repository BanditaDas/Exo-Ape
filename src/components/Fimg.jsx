        ...
        <div ref={parent} className='w-full h-[75vh] sm:h-[150vh] bg-white flex items-center justify-center overflow-hidden'>
            <div className="w-[37%] h-2/4 relative sm:w-[25%] sm:h-[75%]">
                ...
                <div ref={forth} className="absolute aspect-video w-[8.5rem] h-[9rem] -right-[32vw] top-52 sm:w-[25rem] sm:h-[30rem] sm:-right-[27vw] sm:top-[45vw]">
                    <video autoPlay muted loop className='w-full h-full object-cover' src="/f5.mp4"></video>
                </div>
                <img className='w-full h-full object-cover' src="/f1.webp" alt="" />
            </div>
        </div>
    )
}
